...
def rasterization(
    ...
    if colors.shape[-1] > channel_chunk:
        ...
        for i in range(n_chunks):
            ...
            render_colors_, render_alphas_, gs_weights, pixels = rasterize_to_pixels(
                means2d,
                conics,
                colors_chunk,
                opacities,
        ...
        render_colors, render_alphas, gs_weights, pixels = rasterize_to_pixels(
            means2d,
            conics,
            colors,
            opacities,
