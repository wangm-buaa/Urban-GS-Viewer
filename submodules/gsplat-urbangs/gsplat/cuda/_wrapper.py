...
def rasterize_to_pixels(
    ...
    render_colors, render_alphas, weights, pixels = _RasterizeToPixels.apply(
        means2d.contiguous(),
        conics.contiguous(),
        colors.contiguous(),
    ...
    return render_colors, render_alphas, weights, pixels
...
class _RasterizeToPixels(torch.autograd.Function):
    ...
    def forward(
        ...
        render_colors, render_alphas, last_ids, weights, pixels = _make_lazy_cuda_func(
...
def rasterize_to_pixels_2dgs(
    ...
    # pdb.set_trace()
    return render_colors, render_alphas, render_normals, render_distort, render_median, weights
